namespace SmsWorkbench
{
    ...
    public static class SettingsCatalog
    {
        ...
        public static IReadOnlyList<SettingsCategoryDefinition> Categories { get; } = new[]
        {
            ...
            Category("注册与接码",
                Section("接码供应商",
                    Options("phone_source", "供应商", "phone_reuse.source", "smsbower", "smsbower", "sms66")),
                Section("SMSBower",
                ...
                Section("SMS66",
                    Secret("sms66_api_key", "SMS66 API Key", "phone_reuse.sms66.api_key"),
                    Text("sms66_endpoint", "API 地址", "phone_reuse.sms66.endpoint", "https://app.yuntl.cc"),
                    Integer("sms66_project_id", "项目 ID", "phone_reuse.sms66.project_id", "480"),
                    Integer("sms66_country_id", "国家 ID", "phone_reuse.sms66.country_id", "1"),
                    Text("sms66_phone_prefix", "号段前缀", "phone_reuse.sms66.phone_prefix"),
                    Text("sms66_designated_phone", "指定号码", "phone_reuse.sms66.designated_phone"),
                    Integer("sms66_sms_timeout", "短信等待秒", "phone_reuse.sms66.sms_timeout", "120"),
                    Integer("sms66_sms_poll_interval", "短信轮询间隔秒", "phone_reuse.sms66.sms_poll_interval", "5"),
                    Integer("sms66_max_reuse_count", "号码复用次数", "phone_reuse.sms66.max_reuse_count", "5")),
                Section("Codex OAuth",
            ...
            Category("网络与支付",
                ...
                Section("协议管理",
                    ...
                    Text("protocol_enabled_methods", "启用方式", "", "paypal,upi,ideal,pix,kakao,blik,twint,direct_card,momo"),
